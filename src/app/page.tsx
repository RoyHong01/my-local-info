  ...
  return (
    <div className="bg-[#F9F9F7] font-sans text-stone-800">
      ...
      <section className="pt-10 pb-8">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <div className="bg-white rounded-xl px-5 py-5 shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex flex-col items-center justify-center text-center min-h-[8.5rem]">
              <div className="min-w-0">
                <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-2 leading-snug">알았을 때는 이미 신청 마감</h3>
                <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">마감일 하루 전날 알면 이미 늦습니다.</p>
              </div>
            </div>
            <div className="bg-white rounded-xl px-5 py-5 shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex flex-col items-center justify-center text-center min-h-[8.5rem]">
              <div className="min-w-0">
                <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-2 leading-snug">주말마다 &quot;어디 가지?&quot; 검색만 하다 끝</h3>
                <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">내 주변 축제, 아무도 정리해주지 않습니다.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pt-16 md:pt-20 pb-20" id="categories">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 mb-10 md:mb-12">
          <div
            aria-hidden="true"
            className="h-px w-full bg-gradient-to-r from-transparent via-stone-300/80 to-transparent"
          />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {categories.map(cat => (
              <div key={cat.id} id={cat.id} className="space-y-4 scroll-mt-24">
                ...
                <Link
                  href={cat.href}
                  className={`flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-bold ${cat.linkColor} transition-colors`}
                >
                  더보기
      ...
      <section className="pt-10 sm:pt-12 pb-16 sm:pb-20 bg-gradient-to-b from-orange-50 to-orange-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
