    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
      {items.map((item, i) => {
        ...
        return (
          ...
          >
            <div className="menu-card bg-white rounded-2xl p-5 shadow-sm border border-stone-100 border-t-2 border-t-blue-500 hover:shadow-md hover:border-blue-200 transition-all duration-300 flex flex-col cursor-pointer min-h-[220px] max-h-[280px] overflow-hidden">
