...
- Codex API (Codex-haiku-4-5) → 인천/보조금/축제 데이터 description 생성
...
| 변수 | 용도 | 상태 |
|------|------|------|
| ANTHROPIC_API_KEY | Codex API 데이터 description 생성 | ✅ |
...
scripts/
  ...
  generate-blog-post.js # Codex API 블로그 자동 생성 (카테고리당 2편)
...
## 작업 규칙
1. 작업 시작 시 이 파일(AGENTS.md) 먼저 읽기
