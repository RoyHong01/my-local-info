...
- 2026-04-08 핵심 반영:
  - **맛집 재수집 시점 수정**: GitHub Actions 04:00 full 실행 시에도 `collect-life-restaurants.mjs`를 매일 무조건 돌리지 않고, `ensure-life-restaurant-candidates.mjs`가 기존 `restaurants.json` 후보 소진 여부를 점검한 뒤 필요할 때만 재수집
