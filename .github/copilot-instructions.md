...
10. **초이스 포스트 본문 배너 금지**: 쿠팡 배너/링크는 본문(마크다운 body) 안에 절대 삽입하지 않는다. 쿠팡 배너는 frontmatter(`coupang_banner_image`)를 통해 사이드바에서 자동 렌더링된다. 본문에는 제품 정보·큐레이션 콘텐츠만 작성한다.
...
- 2026-04-13 핵심 반영(추가):
  ...
  - **용어 통일 및 비교 섹션 개선**: "오늘의 추천 상품" 기준으로 통일, 하단 2개 상품은 가로 비교 테이블(GFM) + 연결 문구 적용
