...
- 아래 흐름을 반드시 포함:
  1) 공감 훅: 일상 장면 + 불편 포인트
  2) **Before 시나리오**: 제품 사용 전 불편함을 구체 장면으로 묘사
  3) **After 시나리오**: 사용 후 달라진 루틴/감정/시간 흐름을 대비해 묘사
...
2) Before & After 구조: "포인트 3가지" 형식 대신 사용자 가상 시나리오를 중심으로, 사용 전(Before)과 사용 후(After)의 대비를 본문 중심축으로 쓸 것.
...
[시나리오 섹션 작성 규칙]
- 아래 2개 소제목을 반드시 포함하거나, 의미가 같은 자연어 소제목으로 치환할 것:
  - "## Before: (사용 전 불편한 일상 장면)"
  - "## After: (사용 후 달라진 일상 장면)"
