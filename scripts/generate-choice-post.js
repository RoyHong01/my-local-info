...
[쿠팡태그 삽입 규칙]
- 쿠팡 배너/링크는 본문 중간에 절대 삽입 금지
- 쿠팡 배너는 사이드바(frontmatter coupang_banner_image)에서 자동 처리됨
- 본문에는 제품 정보와 큐레이션 콘텐츠만 작성
...
3) 본문 중간에 추가 상세 이미지 마크다운은 넣지 말 것(상단 대표 이미지와 중복 방지)
